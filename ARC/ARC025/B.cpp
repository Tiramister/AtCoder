...
int main() {
    ...
    VVI black(H + 1, VI(W + 1, 0));
    VVI white(H + 1, VI(W + 1, 0));
    ...
    FOR(hi, 1, H) {
        FOR(wi, 1, W) {
            FOR(hj, hi, H) {
                FOR(wj, wi, W) {
                    int bnum = black[hj][wj] - black[hi - 1][wj] - black[hj][wi - 1] + black[hi - 1][wi - 1];
                    int wnum = white[hj][wj] - white[hi - 1][wj] - white[hj][wi - 1] + white[hi - 1][wi - 1];
                    if (bnum == wnum) {
                        ans = max(ans, (hj - hi + 1) * (wj - wi + 1));
                    }
                }
            }
        }
